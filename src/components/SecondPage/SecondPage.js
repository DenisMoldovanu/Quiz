  ...
  return (
    <div className="page">
      ...
      <p>
        ...
        HAND COLUMN THE ONE, TWO OR THREE SENTENCES MOST APPLICABLE TO YOURSELF.
        THEN IN THE COLUMN ON THE RIGHT, APPORTION 10 POINTS BETWEEN THOSE
        SENTENCES THAT APPLY TO YOU: ONE OF WHICH YOU FEEL SUMS YOU UP WELL
        WHILE THE OTHER ONLY APPLIES SOME OF THE TIME.
      </p>
      <p>
        ...
        DECIDE THAT THERE ARE TWO SENTENCES THAT APPLY TO YOU EQUALLY - IF THIS
        IS THE CASE, AWARD FIVE POINTS TO EACH.
      </p>
