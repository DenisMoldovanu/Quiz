  ...
  return (
    <div>
      <div className="page">
        ...
        <p>
          IN ORDER TO FUNCTION AT FULL CAPACITY AND TO BENEFIT FROM EACH
          MEMBER’S ABILITIES, RED CIRCLE MAFIA, LIKE ANY OTHER DAO, NEEDS ITS
          MEMBERS TO MAKE FULL USE OF THE ABILITIES THEY POSSESS
        </p>
        <p>
          WE, PEOPLE WHO KNOW HOW TO BRING OUT THE BEST OUT OF PEOPLE, HAVE
          CREATED THIS TEST. BY COMPLETING IT, YOU WILL FIND OUT WHAT ROLE YOU
          FIT IN THE DAO YOU BELONG TO. AND YOU WILL AUTOMATICALLY BE GIVEN THE
          ROLE ON THE SERVER.
        </p>
      </div>
